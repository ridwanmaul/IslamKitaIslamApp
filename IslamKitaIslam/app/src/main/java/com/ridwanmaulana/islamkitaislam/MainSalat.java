...
public class MainSalat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_salat);
    ...
    private void loadKota(){
        try {
            String api = "/kota";
            ClientAsyncTaskSalat task = new ClientAsyncTaskSalat(this, api, new ClientAsyncTaskSalat.OnPostExecuteListener() {
                @Override
    ...
    private void loadJadwal(int id){
        try {
            ...
            ClientAsyncTaskSalat task = new ClientAsyncTaskSalat(this, api_url, new ClientAsyncTaskSalat.OnPostExecuteListener() {
                @Override
                public void onPostExecute(String result) {

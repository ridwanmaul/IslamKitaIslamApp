...
public class ClientAsyncTaskSalat extends AsyncTask<Void, Void, String> {
    ...
    public ClientAsyncTaskSalat(Context mContext, String api_url, OnPostExecuteListener mPostExecuteListener){
